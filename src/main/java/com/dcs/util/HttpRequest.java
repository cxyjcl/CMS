...
public class HttpRequest {
	...
	public  void testSynchronized(Thread t) {
		// System.out.println("<---" + t.getName() +
		// " start the testMethod--->");
		// try {
		// Thread.sleep(1000);
		// System.out.println("<---" + t.getName() + " end the sleep--->");
		// for (int i = 0; i < 5; i++) {
		// System.out.println("<---" + t.getName() + "----working " + i
		// + "--->");
		// }
		// System.out.println("<---" + t.getName() + " end the job--->");
		//
