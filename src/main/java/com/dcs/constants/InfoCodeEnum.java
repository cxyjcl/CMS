...
public enum InfoCodeEnum {
	...
	LectureInfo("10010","LectureInfoServiceImpl.class"),//年级讲座统计表
	PlanConclusion("10011","PlanConclusionServiceImpl.class"),//工作计划及总结
	GraduateDispatch("10012","GraduateDispatchServiceImpl.class"),//毕业生派遣方案（毕业年级）
	IndividualAchievements("10013","IndividualAchievementServiceImpl.class"),//个人成果及获奖情况
	
	//分团委
	CadresInfo("10014","CadresInfoServiceImpl.class"),//分团委、学生会、协会人员名单
	StudentReward("10015","StudentRewardServiceImpl.class"),//学生荣誉名单（团委）
	TotalActivities("10016","TotalActivitiesServiceImpl.class"),//学期开展活动汇总表及方案
